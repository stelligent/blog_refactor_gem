...
Gem::Specification.new do |spec|
  ...
  spec.require_paths = ["lib", "lib/tasks", "lib/steps", "lib/store", "/lib/steps/commit", "/lib/steps/acceptance", "lib/steps/utils"]

  spec.add_runtime_dependency "rake", "~> 10.0"
  spec.add_runtime_dependency "foodcritic", "~> 7.1"
  spec.add_runtime_dependency "aws-sdk-core", "~> 2.3"
